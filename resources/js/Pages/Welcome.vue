                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="#" class="underline text-gray-900 dark:text-white">SaaS Development</a>
                            </div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="#" class="underline text-gray-900 dark:text-white">DevOps</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                DevOps is a way of creating custom server setups for customers quickly and without errors. It uses tools to automate the process and ensure that everything is tested and deployed correctly. By monitoring the servers, any problems can be fixed quickly. This helps ensure a smooth and efficient process for creating custom server setups.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="#" class="underline text-gray-900 dark:text-white">News</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Our company regularly publishes articles on the latest client showcases and new web technologies for websites and SaaS products. Our team of experienced professionals shares their knowledge and expertise in web development, design, and online marketing. Explore our articles to stay ahead of the competition and discover the latest trends in web technology.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                We utilize a distributed system to connect with our network of clients and partners globally. This network allows us to provide consistent and reliable services to all of our partners, regardless of their location. We collaborate in real-time, leveraging technology like video conferencing and instant messaging to ensure efficient and effective communication. 
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        ...
                        <a href="https://imagewize.com" class="ml-1 underline">
                            Made with Love by Imagewize
                        </a>
                    </div>
                </div>
